...
debug_panel.innerHTML = "<div class='debug-panel-header'>Properties</div><div class='debug-panel-content'><div class='prop'><label>Width:</label><div class='val'>"+el_content.offsetWidth+"px</div></div><div class='prop'><label>Height:</label><div class='val'>"+el_content.offsetHeight+"px</div></div></div><div class='debug-panel-header'>ISI Rules</div><div class='debug-panel-content'><div class='prop'><label>Autoscroll:</label><div class='val'>"+debug_isi_autoscroll+"</div></div><div class='prop'><label>Speed:</label><div class='val'>"+debug_isi_scroll_speed+"px per second</div></div><div class='prop'><label>Delay:</label><div class='val'>"+debug_isi_scroll_delay+"ms</div></div><div class='prop'><label>Hard Stop:</label><div class='val'>"+debug_isi_scroll_stop+"ms</div></div><div class='prop'><label>On Hover:</label><div class='val'>"+debug_isi_scroll_hover+"</div></div><div class='prop'><label>Size:</label><div class='val'>"+banner_size+"%</div></div></div>";
